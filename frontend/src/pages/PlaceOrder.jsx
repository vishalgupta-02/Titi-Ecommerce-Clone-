  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <input type="email" placeholder="YOUR EMAIL" className="border border-gray-500 rounded py-1.5 px-3.5 w-full"/>
        ...
        <input type="number" placeholder="PHONE_NUMBER" className="border border-gray-500 rounded py-1.5 px-3.5 w-full"/>
      </div>
      {/* ----------------------------Right ISde------------------ */}
      <div className="mt-8">
